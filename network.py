...
class Network(object):
    ...
    def write_html(self, name, local=True, notebook=False):
        ...
        if notebook:
            ...
            ########################################### TRECHO ALTERADO PELO AUTOR ###########################################
            
            # with tempfile.mkdtemp() as tempdir: # JÁ ESTAVA COMENTADO ANTES DA ALTERAÇÃO
            #if os.path.exists(f"{tempdir}/lib"):                                            # COMENTADO PELO AUTOR
            #    shutil.rmtree(f"{tempdir}/lib")                                             # COMENTADO PELO AUTOR
            #shutil.copytree(f"{os.path.dirname(__file__)}/templates/lib", f"{tempdir}/lib") # COMENTADO PELO AUTOR
