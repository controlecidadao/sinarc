...
O SINARC permite integrar outras bases de dados, inclusive criadas pelo próprio usuário, sendo necessário apenas que o arquivo CSV possua uma coluna com o CNPJ.
