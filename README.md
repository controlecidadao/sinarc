...
[Clique aqui e baixe a versão compactada da pasta SINARC](https://drive.google.com/file/d/1GMLKDgQ5zpd7nJJoXtCZlTHAX-xcqOl_/view?usp=sharing
) (20 GB), contendo os programas e a base de dados completa de CNPJ disponibilizada pela Receita Federal em **08/02/2025** (base de dados atualizada mensalmente). Esta pasta pode ser descompactada e salva em um pen drive, HD externo ou mesmo no computador (necessários 70 GB de espaço livre), **prescindindo de instalação**.
