...
Como sistema de inteligência para fontes abertas (_Open Source Intelligence - [OSINT](https://www.cia.gov/stories/story/ic-osint-strategy-rollout/))_ em permanente evolução, alinhado às Doutrinas de Inteligência da [Agência Brasileira de Inteligência (ABIN)](https://www.gov.br/abin/pt-br/centrais-de-conteudo/publicacoes/doutrina/Doutrina-da-Atividade-de-Inteligencia-2023) e da [Rede Nacional de Informações Estratégicas para o Controle Externo (Rede InfoContas)](https://escon.tcero.tc.br/publicacoes/e-books/), o SINARC se propõe a ampliar as perspectivas de análise das conexões existentes entre **informações públicas** sobre **pessoas físicas** (PF), **pessoas jurídicas** (PJ e PE), **endereços** (EN), **telefones** (TE) e **e-mails** (EM) constantes na [base de dados pública de CNPJ](https://arquivos.receitafederal.gov.br/index.php/s/YggdBLfdninEJX9) da Receita Federal, formada por **68 milhões de CNPJs**, por meio dos seguintes recursos:
...
3. **Integração com outras bases de dados** oficias públicas e com sistemas de Inteligência Artificial para **produção de conhecimento** e de _insights_ sob múltiplas perspectivas.
...
O arquivo _SINARC.zip_ possui 20 GB ([SHA-256](https://emn178.github.io/online-tools/sha256_checksum.html): _ab293c16e513983332fecbd7506c7b95550d8ad28a144007c242a26816e475f1_).
