...
<br><br>
> ✅ Na pasta SINARC, clique 2 vezes no arquivo **_abre_rede_cnpj.bat_** (o Windows solicitará sua confirmação por se tratar de um arquivo executável _.bat_). Uma instância do Terminal do Rede CNPJ será aberta. Aguarde a interface do Rede CNPJ ser exibida em uma nova aba do navegador;
<br><br>
