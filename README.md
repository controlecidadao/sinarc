...
QR Codes permitem a abertura e exploração dos grafos online em aparelhos celulares (recurso em fase de teste). Clique no botão localizado no centro da parte inferior da tela para abrir o teclado do celular e digitar os comandos do SINARC. Navegador sugerido: Google Chrome.
