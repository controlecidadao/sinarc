...
[Clique aqui e baixe a versão compactada da pasta SINARC]() (20 GB), contendo a base de dados completa de CNPJ disponibilizada pela Receita Federal em **08/02/2025** (base de dados atualizada mensalmente). Esta pasta pode ser descompactada e salva em um pen drive (necessários 70 GB de espaço livre), prescindindo de instalação no computador.
