...
⚠️ **ATENÇÃO:** O SINARC apenas sinaliza com uma bandeira vermelha (🚩) a presença do CNPJ nas bases de dados oficiais, somando os valores existentes quando disponíveis em coluna específica. Para obter detalhes sobre uma ocorrência, consulte a respectiva base de dados primária por meio dos links acima. 
