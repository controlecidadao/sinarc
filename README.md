![v](https://img.shields.io/badge/Versão-0.6.0-blue)
[![License: MIT](https://img.shields.io/badge/Licença-MIT-green.svg)](https://opensource.org/licenses/MIT)
![v](https://img.shields.io/badge/Atualização-%2003%20de%20Junho%20de%20%202026-green)
...
<p align="center" width="100%">
<img width="20%" class="clickable-image" src="./images/qrcode_readme.png" alt="QR Code" />
</p>
...
De igual modo, reconhece-se a relevância do projeto _open source_ [Minha Receita](https://docs.minhareceita.org/), que disponibiliza de forma livre e gratuita uma API pública para consulta estruturada aos dados de CNPJ da Receita Federal. Integrada ao SINARC como uma de suas consultas externas, essa iniciativa é fruto do trabalho colaborativo de desenvolvedores comprometidos com a democratização do acesso à informação pública, cuja dedicação ao aprimoramento contínuo da ferramenta fortalece o **ecossistema brasileiro de dados abertos** e amplia as possibilidades de exercício do controle social sobre a Administração Pública.

Como sistema de inteligência de fontes abertas (_Open Source Intelligence - [OSINT](https://www.cia.gov/stories/story/ic-osint-strategy-rollout/))_ em permanente evolução, alinhado aos conceitos extraídos da [Doutrina de Inteligência](https://www.gov.br/abin/pt-br/centrais-de-conteudo/publicacoes/doutrina/Doutrina-da-Atividade-de-Inteligencia-2023) da Agência Brasileira de Inteligência (ABIN) e da [Doutrina de Inteligência](https://www.tcepi.tc.br/wp-content/uploads/2026/04/doutrina-de-inteligencia-de-controleexterno-da-rede-infocontas.pdf) da Rede Nacional de Informações Estratégicas para o Controle Externo (Rede InfoContas), o SINARC se propõe a ampliar as perspectivas de análise das conexões existentes em **informações públicas** sobre **pessoas jurídicas** (PJ), **pessoas físicas** (PF) - sócios, administradores etc. -, **endereços** (EN), **telefones** (TE) e **e-mails** (EM) empresariais constantes na [base de dados pública de CNPJ](https://arquivos.receitafederal.gov.br/index.php/s/YggdBLfdninEJX9) da Receita Federal ([dicionário de dados](https://www.gov.br/receitafederal/dados/cnpj-metadados.pdf)), formada por **70 milhões de CNPJs**, por meio dos seguintes recursos:
...
3. **Integração com outras bases de dados oficiais públicas** e com sistemas de Inteligência Artificial para **produção de conhecimento e de insights** sob múltiplas perspectivas.
...
|  3 | CGU             | Cadastro de Empresas Inidôneas e Suspensas (CEIS)             | 30/04/2026        | 02/05/2026       | [Link](https://dados.gov.br/dados/conjuntos-dados/ceis)        |
|  4 | CGU             | Cadastro Nacional de Empresas Punidas (CNEP)                  | 30/04/2026        | 02/05/2026       | [Link](https://dados.gov.br/dados/conjuntos-dados/cnep)        |
|  5 | CGU             | Cadastro Nacional de Entidades Privadas Impedidas (CEPIM)     | 29/04/2026        | 02/05/2026       | [Link](https://dados.gov.br/dados/conjuntos-dados/cepim-entidades-privadas-sem-fins-lucrativos-impedidas)        |
|  6 | CGU             | Acordos de Leniência                                          | 01/05/2026        | 02/05/2026       | [Link](https://dados.gov.br/dados/conjuntos-dados/acordos-de-leniencia)        |
|  7 | CGU             | Favorecidos por Emendas PIX da União                          | 2020 a 2026       | 02/05/2026       | [Link](https://portaldatransparencia.gov.br/download-de-dados/emendas-parlamentares-documentos)        |
|  8 | CGU             | Favorecidos por pagamentos da União (SIAFI)                   | 04/2026           | 02/05/2026       | [Link](https://dados.gov.br/dados/conjuntos-dados/portal-da-transparencia-lista-de-favorecidos-pessoa-juridica)        |
|  9 | PGFN            | Dívida ativa previdenciária (PREV)                            | 12/2024 e 12/2025 | 02/03/2026       | [Link](https://www.gov.br/pgfn/pt-br/assuntos/divida-ativa-da-uniao/transparencia-fiscal-1/dados-abertos)        |
|  10 | PGFN            | Dívida ativa com FGTS (FGTS)                                  | 12/2024 e 12/2025 | 02/03/2026       | [Link](https://www.gov.br/pgfn/pt-br/assuntos/divida-ativa-da-uniao/transparencia-fiscal-1/dados-abertos)        |
|  11 | PGFN            | Dívida ativa geral (SIDA)                                    | 12/2024 e 12/2025 | 02/03/2026       | [Link](https://www.gov.br/pgfn/pt-br/assuntos/divida-ativa-da-uniao/transparencia-fiscal-1/dados-abertos)        |
| 12 | CVM             | Companhias de capital aberto (fre_cia_aberta_2025.csv)        | 2025              | 02/05/2026       | [Link](https://dados.cvm.gov.br/dataset/cia_aberta-doc-fre)        |
| 13 | CADE            | Acordos de Leniência (arquivos sem CNPJ)                      | 🚧                 | A INCLUIR        | [Link](https://dados.gov.br/dados/conjuntos-dados/base-de-dados-dos-acordos-de-leniencia)        |
| 14 | MTE             | Trabalho análogo ao de escravo                                | 29/04/2026        | 03/05/2026       | [Link](https://dados.gov.br/dados/conjuntos-dados/trabalho-analogo-ao-de-escravo)        |
| 15 | ANAC            | Registro Aeronáutico Brasileiro (RAB) - Proprietários         | 03/05/2026        | 03/05/2026       | [Link](https://www.gov.br/anac/pt-br/sistemas/rab/dados-abertos-rab)        |
| 16 | IBAMA           | Autos de infração ambiental                                   | 2020 a 2026       | 03/05/2026       | [Link](https://dados.gov.br/dados/conjuntos-dados/fiscalizacao-auto-de-infracao)        |
| 17 | TCU             | Licitantes inidôneos                                          | 01/05/2026        | 03/05/2026       | [Link](https://sites.tcu.gov.br/dados-abertos/inidoneos-irregulares)        |
| 18 | TCU             | Responsáveis com contas julgadas irregulares                  | 01/05/2026        | 03/05/2026       | [Link](https://sites.tcu.gov.br/dados-abertos/inidoneos-irregulares)        |
| 19 | TCU             | Multas e ressarcimentos aplicados pelo TCU                    | 🚧                | A INCLUIR        | [Link](https://dados.gov.br/home)        |
| 20 | TCE-ES          | Empresas inidôneas                                            | 01/05/2026         | 03/05/2026       | [Link](https://dados.es.gov.br/dataset/lista-de-responsaveis-consultas-tcees/resource/ca979cb0-7ee5-4d91-af6c-804a353b9ef2)        |
| 21 | TCE-ES          | Proibidos de contratar com a Administração Pública            | 01/05/2026        | 03/05/2026       | [Link](https://dados.es.gov.br/dataset/lista-de-responsaveis-consultas-tcees/resource/2c27a170-e415-4b9d-9679-49a65903979a)        |
| 22 | TCE-ES          | Responsáveis com contas julgadas irregulares                  | 01/05/2026        | 03/05/2026       | [Link](https://dados.es.gov.br/dataset/lista-de-responsaveis-consultas-tcees/resource/d2a18709-9c15-46da-bdbd-fbc3ddbc2202)        |
| 23 | TCE-ES          | Responsáveis inabilitados                                     | 01/05/2026        | 03/05/2026       | [Link](https://dados.es.gov.br/dataset/lista-de-responsaveis-consultas-tcees/resource/4fe9a28d-02b4-438b-851b-ea33904f2344)        |
| 24 | TCE-ES          | Favorecidos por Emendas PIX da União no ES                    | 2020 a 2026       | 01/05/2026       | [Link](https://dados.es.gov.br/dataset/tcees-empenho)        |
| 25 | TCE-ES          | Empenhos emitidos por municípios do ES                        | 2020 a 2026       | 01/05/2026       | [Link](https://dados.es.gov.br/dataset/tcees-empenho)        |
| 26 | MPC-ES          | Multas e ressarcimentos aplicados pelo TCE-ES                 | 🚧                | A INCLUIR       | [Link](https://www.mpc.es.gov.br/cobrancas/)        |
| 27 | SEFAZ-ES        | Empenhos emitidos pelo Estado do Espírito Santo               | 2020 a 2026       | 30/04/2026       | [Link](https://dados.es.gov.br/dataset/portal-da-transparencia-despesas-execucao-orcamentaria-e-financeira)        |
| 28 | SEFAZ-ES        | Renúncia de Receita (COMPETE-ES e INVEST-ES)                  | 04/2026           | 04/05/2026       | [Link](https://transparencia.es.gov.br/Comum/IncentivosFiscais)        |
| 29 | SEFAZ-ES        | Dívida ativa com o ES                                         | 🚧               | A INCLUIR        | [Link](https://dados.es.gov.br/dataset?q=SEFAZ&sort=score+desc%2C+metadata_modified+desc)        |
| 30 | SECONT-ES       | Processos Administrativos de Responsabilização (PAR)          | 06/2025           | 04/05/2026       | [Link](https://dados.es.gov.br/dataset/par)        |
| 31 | SEGER-ES       | Licitantes constantes no sistema SIGA (ItensLotesDisputas)     | 2020 a 2026       | 03/05/2026       | [Link](https://dados.es.gov.br/dataset/portal-da-transparencia-compras-publicas)        |
| 32 | IEMA-ES        | Autos de Infração Ambiental                               | 🚧                | A INCLUIR       | [Link](https://dados.es.gov.br/dataset?q=iema&sort=score+desc%2C+metadata_modified+desc)        |
...
O arquivo _SINARC.zip_ possui 22 GB ([SHA-256](https://emn178.github.io/online-tools/sha256_checksum.html): _897325a0b02cc9fc3368eb00df973344a3ab34dde0dd5936e0461b1590a7f52f_).
...
As relações identificadas por meio da ferramenta representam padrões derivados de dados públicos disponíveis, não devendo ser interpretadas como prova de irregularidade, ilícito ou conduta indevida. Conexões entre entidades refletem situações legítimas e demandam análise contextual cuidadosa.
...
Respostas geradas por sistemas de Inteligência Artificial podem conter erros decorrentes, principalmente, das fontes consultadas na internet, do viés dos dados de treinamento, das limitações da tecnologia empregada (rede _Transformers_) e dos ajustes internos do modelo LLM utilizado (hiperparâmetros).
...
* atentar para a data de extração dos dados;
